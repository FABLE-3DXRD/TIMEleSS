...
"""
def ID27_hdf5_To_Esg(hdffile, edfimagepath, stem, fromm, to, step, digits,dounderscore,maxthreshold=None):
...
def main(argv):
	...
	ID27_hdf5_To_Esg(inputfile, edfimagepath, stem, fromm, to, step, digits,dounderscore, maxthreshold)
