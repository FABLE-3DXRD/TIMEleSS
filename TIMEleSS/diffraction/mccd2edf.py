...
def mccdToEdf(mccdimagepath, edfimagepath, stem, extension, fromm, to, step, first,digits,dounderscore):
...
def main(argv):
	...
	mccdToEdf(mccdimagepath, edfimagepath, stem, extension, fromm, to, step, first,digits,dounderscore);
